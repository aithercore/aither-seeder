...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Aither-seeder\n"
...
static const string mainnet_seeds[] = {"seed-1.aithercoin.com","seed-2.aithercoin.com","seed-3.aithercoin.com",""};
static const string testnet_seeds[] = {"test.seed-1.aithercoin.com","test.seed-2.aithercoin.com",""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("aithercoin.com", 40888), true);
  }
  do {
